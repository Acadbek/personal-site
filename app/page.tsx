  ...
  return (
    ...
    >
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          {PROJECTS.map((project) => (
            <div key={project.name} className="space-y-2">
              <div className="relative rounded-2xl bg-zinc-50/40 p-1 ring-1 ring-zinc-200/50 ring-inset dark:bg-zinc-950/40 dark:ring-zinc-800/50">
                <ProjectImage src={project.src} previewImg={project.previewImg} />
              </div>
              <div className="px-1">
          ...
          >
            <div className='flex items-center gap-3'>
              <div className='tracking-wide text-gray-600'>I'm building <a className='underline text-black' target='_blank' href='https://salom-ui.vercel.app'>Salom UI</a> Design-ready UI components with <span className='text-black'>shadcn registry</span> </div>
            </div>
          </motion.section> */}
        </div>
      </motion.section>
      ...
      >
        ...
        <Link href="/likes" className="underline dark:text-zinc-300">
          Likes
        </Link>
